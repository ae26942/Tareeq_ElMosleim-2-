...
const sections = [
    { name: 'أذكار الصباح', color: 'green', icon: '☀️', id: 'azkar-sabah', type: 'azkar' },
    { name: 'أذكار المساء', color: 'blue', icon: '🌙', id: 'azkar-masaa', type: 'azkar' },
    { name: 'أذكار النوم', color: 'yellow', icon: '😴', id: 'azkar-noom', type: 'azkar' },
    { name: 'أذكار الاستيقاظ', color: 'purple', icon: '🌅', id: 'azkar-estikaaz', type: 'azkar' },
